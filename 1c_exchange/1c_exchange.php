...
//        'REQUEST'=>$_REQUEST,
//    );
//	$defaultFileDir = $_SERVER['DOCUMENT_ROOT'].'/local/var/logs';
//	$fileName = $defaultFileDir.'/1c_exchange_' . $_REQUEST["type"] . '_' . date('Ymd') . '.log';
//    file_put_contents($fileName, print_r($arDate, true), FILE_APPEND);
//}
...
if($type=="sale")
{
	$APPLICATION->IncludeComponent("citfact:sale.export.1c", "", Array(
...
elseif($type=="catalog")
{
    $APPLICATION->IncludeComponent("citfact:catalog.import.1c", "", Array(
