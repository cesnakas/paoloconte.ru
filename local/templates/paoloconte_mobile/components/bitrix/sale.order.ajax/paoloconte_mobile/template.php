...
<script>
    $(document).ajaxSuccess(function(){
        if ($("div").is('#order_errors_cont_personal')) {
            $('body').scrollTop('div#order_errors_cont_personal');
        } else {
            if ($("div").is('#order_errors_cont_delivery')) {
                $('body').scrollTop('div#order_errors_cont_delivery');
            } else {
                if ($("div").is('#order_errors_cont_address')) {
                    $('body').scrollTop('div#order_errors_cont_address');
                }
            }
        }
    });
