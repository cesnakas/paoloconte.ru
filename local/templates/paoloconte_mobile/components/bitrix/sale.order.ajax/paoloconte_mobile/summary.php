...
<div class="personal-box">
	<div class="valign-top">
		<textarea class="full full-height" name="ORDER_DESCRIPTION" id="ORDER_DESCRIPTION" placeholder="Комментарий к заказу"><?=$arResult["USER_VALS"]["ORDER_DESCRIPTION"]?></textarea>
	</div>
</div>

<div class="personal-box submit-box">
...
<div class="personal-box">
	<a href="javascript:void();" onclick="submitForm('Y'); return false;" id="ORDER_CONFIRM_BUTTON" class="btn big btn-gray-dark mode2 icon-arrow-right full">Оформить заказ</a>
	<div class="oferta">
