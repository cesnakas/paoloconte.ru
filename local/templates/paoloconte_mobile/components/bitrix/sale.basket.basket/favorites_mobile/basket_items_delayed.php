			...
			<tr>
				...
				<td>
					...
					<?if ($arResult['STORE_AMOUNT'][ $arItem['PRODUCT_ID'] ] > 0):?>
						...
						<a href="<?=$tovar_url.'?id='.$arItem['PRODUCT_ID'].'&action=ADD2BASKET&ajax_basket=Y'?>" class="btn-tobasket-infavorites" data-product-id="<?=$arItem['PRODUCT_ID']?>"><img src="/local/templates/paoloconte_mobile/images/svg/cart.svg"></a>
					<?endif;?>
				</td>
