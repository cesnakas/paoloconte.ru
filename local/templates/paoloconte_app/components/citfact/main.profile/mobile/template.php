...
<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
	...
	<div class="personal-box">
		...
		<div class="box-title">Личные данные</div>
		...
		<div class="line-input emulate-table">
			...
			<div class="emulate-cell input-cell">
				<input type="text" name="NAME" maxlength="50" value="<?=$arResult["arUser"]["NAME"]?>" class="required" />
		...
		<div class="line-input emulate-table">
			...
			<div class="emulate-cell input-cell">
				<input type="text" name="LAST_NAME" maxlength="50" value="<?=$arResult["arUser"]["LAST_NAME"]?>" class="required" />
				<i class="label-icon label-alert" data-text="Обязательное поле"></i>
			</div>
		</div>
		<div class="line-input emulate-table">
			...
			<div class="emulate-cell input-cell">
				<input type="text" name="PERSONAL_PHONE" maxlength="50" value="<?=$arResult["arUser"]["PERSONAL_PHONE"]?>" class="required mask-phone <?/*error*/?>" placeholder="+7 (123) 456-7890"/>
			</div>
		</div>
		<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
			...
			<div class="emulate-cell input-cell">
				...
				<?/*<input type="text" name="EMAIL" maxlength="50" value="<?=$arResult["arUser"]["EMAIL"]?>" class="required"/>*/?>
			</div>
		</div>
		<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
			...
			<div class="emulate-cell input-cell">
				<input type="text" name="PERSONAL_BIRTHDAY" maxlength="10" value="<?=$arResult["arUser"]["PERSONAL_BIRTHDAY"]?>" class="required mask-date <?/*error*/?>" placeholder="дд.мм.гггг" />
			</div>
		</div>
		<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
		...
		<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
				Номер карты
				<div class="tip">12-значный номер дисконтной карты, указан на обратной стороне карты</div>
			</div>
			<div class="emulate-cell input-cell">
				<input type="text" name="UF_CARDNUMBER" maxlength="20" value="<?=$arResult["USER_PROPERTIES"]['DATA']['UF_CARDNUMBER']['VALUE']?>" class="<?/*required mask-date*/?>" <?/*placeholder="дд.мм.гггг"*/?> />
				<i class="label-icon label-alert" data-text="Необязательное поле"></i>
			</div>
		</div>
	</div>
	...
	<div class="personal-box">
		...
		<div class="line-input emulate-table">
			...
			<div class="emulate-cell input-cell">
				<input type="password" name="NEW_PASSWORD" maxlength="50" value="" autocomplete="off" class="bx-auth-input" placeholder="Введите новый пароль" />
			</div>
		</div>
		<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
			...
			<div class="emulate-cell input-cell">
				<input type="password" name="NEW_PASSWORD_CONFIRM" maxlength="50" value="" autocomplete="off" placeholder="Повторите новый пароль" />
			</div>
		</div>
		<?/*<div class="line-input emulate-table">
			<div class="emulate-cell name-cell">
	...
	<div class="personal-box">
		...
		<div>
				...
				<?foreach ($arResult['ADDRESSES'] as $key => $arAddress):?>
					<div class="address-cont">
						...
						<div class="edit-address-cont" style="display: none;">
							...
							<input type="text" name="address" value="<?=$arAddress['ADDRESS']?>" placeholder="Улица, дом, квартира"/>
							<a href="#" class="btn btn-gray-dark mode2 small icon-arrow-right save-link" data-element-id="<?=$arAddress['ID']?>">Сохранить адрес</a>
						</div>
					</div>
				<?endforeach;?>
			<?endif?>
			...
			<div class="line">
				<a href="#" class="btn btn-gray-dark mode2 small icon-arrow-right addAddress">Добавить адрес</a>
			</div>
			...
			<div class="add-address-cont" style="display: none;">
				...
				<input type="text" name="address" value="" placeholder="Улица, дом, квартира"/>
				<a href="#" class="btn btn-gray-dark mode2 small icon-arrow-right save-link">Сохранить адрес</a>
			</div>
