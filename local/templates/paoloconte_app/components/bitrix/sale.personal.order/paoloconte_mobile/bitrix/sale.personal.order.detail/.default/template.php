			...
			<tbody>
				<?foreach($arResult["BASKET"] as $prod):?>
					<tr>
						...
						<td class="custom img" style="vertical-align: middle">
							<?if($hasLink):?>
								<a href="/paoloconte_app<?=$prod["DETAIL_PAGE_URL"]?>" target="_blank">
							<?endif?>
						...
						<td class="custom name" style="vertical-align: middle">
							<?if($hasLink):?>
								<a href="/paoloconte_app<?=$prod["DETAIL_PAGE_URL"]?>" target="_blank">
							<?endif?>
						...
						<td class="custom price" style="vertical-align: middle"> <span class="fm"><?=GetMessage('SPOD_PRICE')?>:</span> <?=$prod["PRICE_FORMATED"]?></td>
						...
						<?if($arResult['HAS_DISCOUNT']):?>
							<td class="custom price" style="vertical-align: middle"> <span class="fm"><?=GetMessage('SPOD_DISCOUNT')?>:</span> <?=$prod["DISCOUNT_PRICE_PERCENT_FORMATED"]?></td>
						<?endif?>
