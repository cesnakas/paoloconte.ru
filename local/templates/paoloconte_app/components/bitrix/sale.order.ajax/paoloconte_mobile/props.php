...
<div class="personal-info-box">
	...
	<a href="/paoloconte_app/cabinet/personal/">Изменить персональные данные</a>
</div>
<?endif?>
...
<div class="bx_section personal-box <?=($USER->IsAuthorized() === true? 'hidden':'')?>">
	...
	<div id="sale_order_props" <?=($bHideProps && $_POST["showProps"] != "Y")?"style='display:none;'":''?>>
		...
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"], $arUser);
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"], $arUser);
		?>
	</div>
</div>
