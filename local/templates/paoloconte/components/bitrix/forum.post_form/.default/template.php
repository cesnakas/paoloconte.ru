...
<?
	...
	?><div class="forum-reply-field-vote-question"><?
		...
		?></div><?
		?><div class="forum-reply-field-vote-question-options check-box"><?
			?><input type="checkbox" value="Y" name="MULTI[#Q#]" id="MULTI_#Q#" #Q_MULTY# /><?
			?><label class="label" for="MULTI_#Q#"><?=GetMessage("F_VOTE_MULTI")?></label><?
		?></div><?
...
<?
	...
	if ($arResult["SHOW_PANEL_EDIT_ASK"] == "Y")
	{
		...
		?><div class="forum-reply-field-lastedit-view check-box"><?
			...
			?><label class="label" for="EDIT_ADD_REASON<?=$arParams["form_index"]?>"><?=GetMessage("F_EDIT_ADD_REASON")?></label></div><?
	};
...
{
?>
			<div class="forum-reply-field-setting check-box">
				...
				?>tabindex="<?=$tabIndex++;?>" /><?
			?>&nbsp;<label class="label" for="USE_SMILES<?=$arParams["form_index"]?>"><?=GetMessage("F_WANT_ALLOW_SMILES")?></label></div>
<?
};
/* SUBSCRIBE */
...
?>
			<div class="forum-reply-field-setting check-box">
				...
				?>&nbsp;<label  class="label" for="TOPIC_SUBSCRIBE<?=$arParams["form_index"]?>"><?=GetMessage("F_WANT_SUBSCRIBE_TOPIC")?></label></div>
			<div class="forum-reply-field-setting check-box">
				...
				?>&nbsp;<label class="label" for="FORUM_SUBSCRIBE<?=$arParams["form_index"]?>"><?=GetMessage("F_WANT_SUBSCRIBE_FORUM")?></label></div>
<?
};
?>
		</div>
...
?>
		<div class="forum-reply-buttons">
			<div class="get-review review_site btn btn-green big mode1 fa fa-pencil" onclick="this.firstElementChild.click();">
				<input name="send_button" type="submit" value="<?=$arResult["SUBMIT"]?>" tabindex="<?=$tabIndex++;?>" <?
					?>onclick="this.form.MESSAGE_MODE.value = 'NORMAL';"/>
			</div>	

			<div class="btn btn-gray-dark big fa mode1 fa-eye setFilter" onclick="this.firstElementChild.click();">
