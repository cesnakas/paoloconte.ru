                ...
                <div class="basket-item">
                    ...
                    <div class="basket-item__cell basket-item__cell--info">
                        <?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?><a href="<?=$arItem["DETAIL_PAGE_URL"] ?>"><?endif;?>
                            <div class="basket-item__title"><?=$arItem["NAME"]?></div>
                            <?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?></a><?endif;?>
                        <?if ($arItem["RAZMER"] != ''): ?>
                            <div class="basket-item-size">
                                <div class="basket-item-size__current">Размер: <span><?=$arItem["RAZMER"]?></span></div>
                            </div>
                        <?endif?>
                        <?/*=$arItem['ARTICUL']*/?>
                    </div>
                    ...
                    <div class="basket-item__cell basket-item__cell--status">
                        <div class="status">
                            <?//if ($arItem['OFFERS_AMOUNT'] > 0):?>
                            <?if ($arResult['STORE_AMOUNT'][ $arItem['PRODUCT_ID'] ] > 0):?>
                                <span class="round-label true"><i class="fa fa-check"></i></span> Есть на складе
                            <?else:?>
                                <span class="round-label false"><i class="fa fa-times"></i></span> Нет на складе
                            <?endif;?>
        
                            <?// TODO: наличие на складе ?>
                            <?/*
						switch (rand(1,2)) {
							case 1:
								$text=' <span class="round-label true"><i class="fa fa-check"></i></span> Есть на складе';
								break;
							case 2:
								$text='<span class="round-label false"><i class="fa fa-times"></i></span> Нет на складе';
								break;
						}
						echo $text;*/
                            ?>
                    ...
                    <div class="basket-item__cell basket-item__cell--add">
                        <a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["add"])?>" class="btn btn--black"><span>В корзину</span></a>
                        <?//if ($arItem['OFFERS_AMOUNT'] > 0):?>
