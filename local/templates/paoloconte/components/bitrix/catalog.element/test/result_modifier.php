...
$res = CIBlockElement::GetList(array('ID' => 'ASC'), $arFilter, false, false, array("ID", "IBLOCK_ID", "NAME", "DATE_CREATE", "PROPERTY_USER_NAME", "PROPERTY_USER_ID", "PROPERTY_MESSAGE"));
while ($ob = $res->GetNext(false, false)) {
	$arTemp = array();
	$username = '';
...
echo "<pre>";
print_r($arDelGroup);
print_r($allGroupsElement);
print_r($arResult["ELEMENT_ALL_GROUPS"]);
echo "</pre>";
?>
