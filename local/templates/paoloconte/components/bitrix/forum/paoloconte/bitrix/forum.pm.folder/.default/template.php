...
<div class="forum-info-box forum-create-folder">
	<div class="forum-info-box-inner">
		<span class="forum-messages-folder"><?=GetMessage("PM_FOLDER_TITLE")?> 
			...
			<span>
				<div class="btn ok btn-green mode1 icon-arrow-right pm-folder-top" onclick="this.firstElementChild.click();">
					<input class="ok-btn" type="submit" name="SAVE" value="Сохранить" tabindex="2"/>
				</div>
			</span>
		</span>
	</div>
...
<form class="forum-form" action="<?=POST_FORM_ACTION_URI?>" method="POST" <?
	...
	<?=bitrix_sessid_post()?>
<div class="forum-block-container forum-block-container-bottom">
	<div class="forum-block-outer">
		<div class="forum-block-inner">
			<table cellspacing="0" class="forum-table forum-thead-padding">
			<thead>
				<tr>
					...
					<th class="forum-last-column forum-column-action">
						<div class="check-box check-box-size2" onclick="this.firstElementChild.click();">
							<input type="checkbox" name="all_FID__" onclick="FSelectAll(this, 'FID[]');" />
						...
						<div class="forum-footer-inner">
							<div class="forum-topics-moderate">
								...
								<div class="btn ok btn-gray-dark mode1 icon-arrow-right" onclick="this.firstElementChild.click();">
									<input  class="ok-btn"  type="submit" value="OK" onclick="" />
								</div>
							</div>
						</div>
					</td>
