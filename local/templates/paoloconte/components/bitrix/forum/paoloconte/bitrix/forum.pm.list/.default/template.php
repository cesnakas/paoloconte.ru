...
?>
<div class="forum-header-box-pm-folder">
...
<div class="forum-block-container">
	<div class="forum-block-outer">
		<div class="forum-block-inner">
			<table cellspacing="0" class="forum-table forum-pmessages2">
			<thead>
				<tr>
					...
					<th class="forum-last-column forum-column-action">
					<div class="check-box check-box-size2" onclick="this.firstElementChild.click();">
						<input type="checkbox" name="all_message__" onclick="FSelectAll(this, 'message[]');" />
					...
					<td colspan="5" class="forum-column-footer">
						<div class="forum-footer-inner">
							<div class="forum-topics-moderate">
								<div class="btn ok btn-gold mode1 icon-arrow-right" onclick="this.firstElementChild.click();" >
									<input class="ok-btn" type="button" name="action_delete" value="<?=GetMessage("PM_ACT_DELETE")?>" onclick="ChangeAction('delete', this);" />
								</div>
								<span class="forum-white-text"><?=GetMessage("PM_ACT_MOVE")?> <?=GetMessage("PM_ACT_IN")?></span>
								...
								<div class="btn ok btn-gray-dark mode1 icon-arrow-right" onclick="this.firstElementChild.click();" >
									<input class="ok-btn" type="button" name="button_move" value="OK" onclick="ChangeAction('move', this)" />
								</div>
							</div>
						</div>
					</td>
