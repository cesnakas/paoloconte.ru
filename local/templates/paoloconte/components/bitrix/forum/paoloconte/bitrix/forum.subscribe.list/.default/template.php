		...
		<div class="forum-block-inner">
			...
			<thead>
				<tr>
					...
					<th class="forum-last-column">
						<div class="check-box check-box-size2" onclick="this.firstElementChild.click();">
							<input type="checkbox" name="all_SID__" onclick="FSelectAll(this, true);" />
							<label></label>
						</div>
					</th>
				</tr>
				...
				<tr>
					<td colspan="5" class="forum-column-footer">
						<div class="forum-footer-inner">
							<div class="forum-topics-moderate btn ok btn-gray-dark mode1 icon-arrow-right">
								<input class="ok-btn" type="hidden" name="ACTION" value="DEL" />
								<input class="ok-btn" type="submit" value="<?=GetMessage("F_DELETE_SUBSCRIBES")?>" onclick="" />
							</div>
						</div>
					</td>
				</tr>
