...
?>
								...
								<div class="forum-post-moderate-button">
...
?>
	...
	<input class="ok-btn"  onclick="this.form.type.value='messages';this.form.ACTION.value=this.form.ACTION_MESSAGE.value;" <?
...
?>
										...
										<div class="btn ok btn-gray-dark mode1 icon-arrow-right" onclick="this.firstElementChild.click();">
												<input class="ok-btn"  onclick="this.form.type.value='topic';this.form.ACTION.value=this.form.ACTION_TOPIC.value;" <?
										?>type="submit" value="OK" />
