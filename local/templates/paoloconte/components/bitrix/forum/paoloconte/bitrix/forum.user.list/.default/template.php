...
?>
<div class="forum-header-box-user-list <?=(empty($arResult["USERS"])) ? "no-border" : "" ;?>">
	<div class="forum-header-title"><span><?=GetMessage("LU_TITLE_USER")?></span></div>
</div>
<div class="forum-block-container">
	<div class="forum-block-outer">
		<div class="forum-block-inner">
			<table cellspacing="0" class="forum-table forum-users forum-thead-padding">
			<thead>
				<tr>
...
?>
<div class="forum-filter-no-users border">
	<div class="forum-empty-message"><span><?=GetMessage("NO_USERS")?></span></div>
</div>
<?}
if ($arResult["NAV_RESULT"]->NavPageCount > 0):
?>
