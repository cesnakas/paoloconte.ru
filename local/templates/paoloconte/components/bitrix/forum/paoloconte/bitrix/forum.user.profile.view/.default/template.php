...
<table cellspacing="0" border="0" class="forum-post-table forum-post-first forum-post-last forum-post-odd form-profile-bottom">
	<tbody>
		<tr>
...
?>
	<div class="btn ok2 btn-green mode2 icon-arrow-right" onclick="this.firstElementChild.click();">
		<input class="ok-btn2" type="submit" name="VOTE_BUTTON" value="<?=GetMessage("F_DO_VOTE")?>" title="<?=GetMessage("F_DO_VOTE_ALT")?>" id="vote" />
	</div>
...
?>
	<div class="btn ok2 btn-gray-dark mode2 icon-arrow-right" onclick="this.firstElementChild.click();">
		<input class="ok-btn2" type="submit" name="CANCEL_VOTE" value="<?=GetMessage("F_UNDO_VOTE")?>" title="<?=GetMessage("F_UNDO_VOTE_ALT")?>" id="unvote" />
	</div>	
<?
			endif;
?>
