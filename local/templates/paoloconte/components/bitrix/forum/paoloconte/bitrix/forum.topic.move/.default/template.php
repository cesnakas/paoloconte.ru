...
?>
		<div class="forum-topic-move check-box">
...
?>
		<span class="btn ok2 btn-green mode2 icon-arrow-right topic_move_buttom">
			<input class="ok-btn2" type="submit" value="<?=GetMessage("FM_MOVE_TOPIC")?>" name="form_topics_submit" />
			</span> 
		<div class="inline">
		<span><?=GetMessage("F_IN")?></span> 
...
?>
		...
		<div class="forum-topic-move check-box">
			...
			<label class="label" for="leaveLink"><?=GetMessage("FM_LEAVE_LINK")?></label>
		</div>
	</div>
</div>
</form>