...
?>
	<div class="forum-header-box">
		<div class="forum-header-title"><span>Обновления</span></div>
	</div>
...
?>
<div class="forum-header-box-topic-active">
	<div class="forum-header-title"><span><?=GetMessage("F_TITLE")?></span></div>
</div>

<div class="forum-block-container-topic-active">
		...
		<div class="forum-block-inner">
			...
			<thead>
				<tr>
					...
					<th class="forum-column-last"><span><?=GetMessage("F_HEAD_LAST_POST")?></span><?/*?><?=$arResult["SortingEx"]["LAST_POST_DATE"]?><?*/?></th>
				</tr>
			</thead>
			<tbody>
<?
