...
?>
	...
	<div class="forum-reply-fields">
		...
		<div class="forum-reply-field forum-reply-field-settings">
			<div class="forum-reply-field-setting check-box padding">
				<input type="checkbox" name="USE_SMILES" id="USE_SMILES" <?
				?>value="Y" <?=($arResult["POST_VALUES"]["USE_SMILES"]=="Y") ? "checked=\"checked\"" : "";?> <?
				?>tabindex="<?=$tabIndex++;?>" /><label class="label" for="USE_SMILES"><?=GetMessage("F_WANT_ALLOW_SMILES")?></label></div>
...
?>
			<div class="forum-reply-field-setting check-box padding">
				...
				?>
				<label class="label" for="COPY_TO_OUTBOX"><?=GetMessage("F_COPY_TO_OUTBOX")?></label>
			...
			<div class="forum-reply-field-setting check-box padding">
				...
				?><label class="label" for="REQUEST_IS_READ"><?=GetMessage("F_REQUEST_IS_READ")?></label>
...
?>
		...
		<div class="get-review review_site btn btn-green big mode1 fa fa-pencil" onclick="this.firstElementChild.click();" >
			<input class="ok-btn"  type="submit" name="SAVE_BUTTON" id="SAVE_BUTTON" tabindex="<?=$tabIndex++;?>" <?
