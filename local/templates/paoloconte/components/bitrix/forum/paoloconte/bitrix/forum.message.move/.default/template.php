...
<div class="forum-info-box forum-post-move border">
	...
	<div class="forum-reply-fields">
		<div class="forum-reply-field forum-reply-field-topic">	
			...
			<div class="btn ok btn-gray-dark">
				<input class="ok-btn" type="button" name="search" value="..." onClick="window.open('<?=CUtil::JSEscape($arResult["topic_search"])?>', '', 'scrollbars=yes,resizable=yes,width=760,height=500,top='+Math.floor((screen.height - 560)/2-14)+',left='+Math.floor((screen.width - 760)/2-5));" />
			</div>
			<span id="TOPIC_INFO"><?
...
?>
		...
		<div class="move-button btn ok2 btn-green mode2 icon-arrow-right">
			<input class="ok-btn2" type="submit" name="send_form" value="<?=GetMessage("F_BUTTON_MOVE")?>" />
		</div>
	</div>
</div>
<div class="forum-header-box">
