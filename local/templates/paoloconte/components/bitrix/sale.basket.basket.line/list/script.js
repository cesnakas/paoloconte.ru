...
function BitrixSmallCartList(){}

BitrixSmallCartList.prototype = {
	...
	setCartBody: function (result)
	{
        ...
        setTimeout(Application.Components.Main.runPanelHeight(), 1000);
		// Это событие подвешено в шаблоне .default
        BX.onCustomEvent('OnBasketChangeList');
	},
