...
if($USER -> GetID() == 16240){echo"<pre>";print_r($arResult["ITEMS"]);echo"</pre>";}
			...
			<div class="container">
				<div class="action-body">
					<div class="text styled-text-box">
						<?$file = CFile::ResizeImageGet($arItem['PREVIEW_PICTURE']['ID'], array('width'=>160, 'height'=>240), BX_RESIZE_IMAGE_EXACT);
						$str_time = '';
						...
						?>
						<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><div class="image" style="background-image: url('<?=$file['src']?>')">
						</div></a>

						<div class="title">
							<a href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=$arItem['NAME']?></a> <span class="time-box"><?if ($str_time != ''):?><i class="fa fa-clock-o"></i> <?=$str_time?></span><?endif;?>
						</div>
