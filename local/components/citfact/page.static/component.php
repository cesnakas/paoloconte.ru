...
if(CModule::IncludeModule("iblock")){
	...
	$res = CIblockElement::GetList(
		...
		false,
		false,
		array("ID", "IBLOCK_ID", "NAME", "DETAIL_TEXT", "ACTIVE", "DATE_ACTIVE_FROM", "DATE_ACTIVE_TO",
			"PROPERTY_UF_SEO_FLAG", "PROPERTY_UF_META_TITLE", "PROPERTY_UF_META_K", "PROPERTY_UF_META_D", "PROPERTY_UF_SEO_TEXT")
	);
