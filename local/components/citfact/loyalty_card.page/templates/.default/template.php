...
<div class="loyalty_card_wrapper">
    <? if (!$exist_card) { ?>
        <div class="card_info_text">
            <div class="title-4">Здесь вы можете привязать <a target="_blank" href="/about/programma-loyalnosti/">Карту Постоянного Покупателя</a>, чтобы:</div>
            <ul>
            ...
            <div>
                <? if ($exist_card) { ?>
                    <div class="card_number">
                        ...
                        <? } ?>
                        <br>
                        <div class="btn btn--black btn--loyalty">
