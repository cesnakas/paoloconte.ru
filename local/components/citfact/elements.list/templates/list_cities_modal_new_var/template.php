	...
	$(document).ready(function () {
		...
		$( "#city-input" ).autocomplete({
			...
			select: function( event, ui ) {
                ...
                document.cookie = "city-id=" + encodeURIComponent(value);
                location.reload();
	...
	<div class="modal-body block-first-show">
		...
		<div class="emulate-table city-box-1 full">
			<div class="emulate-cell input-cell valign-middle">
				<input type="text" id="city-input" placeholder="Найти город" />
...
<!--						<a href="--><?//=$APPLICATION->GetCurPageParam("city=".$arItem['ID'], array("city"), false);?><!--">--><?//=$arItem['NAME']?><!--</a>-->
                        <a data-marker="1" data-city-id="<?=$arItem['ID']?>" href="javascript:void(0)"><?=$arItem['NAME']?></a>
                    </li>
				<?endforeach?>
			</ul>
			<div class="clear"></div>
