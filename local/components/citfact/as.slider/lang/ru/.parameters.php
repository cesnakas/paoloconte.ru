...
$MESS["T_IBLOCK_DESC_SECTION_ID"] = "Раздел слайдера";
$MESS["T_IBLOCK_DESC_DISPLAY_PREVIEW"] = "Показывать превью слайдов";
$MESS["T_IBLOCK_DESC_ACTIVE_AUTOSCROLLING"] = "Включить автопрокрутку";
?>