$(document).ready(function () {
    ...
    var arParams_promo_index = BX.message('arParams_promo_index');
    //console.log(arParams);

    $('#promo_index_submit').click(function () {
        var form = $(this).parents('form');
        var data = {formdata: form.serialize(), params: arParams_promo_index, sessid: $('input#sessid').val()};
